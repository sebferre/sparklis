...
OBJ=common.cmo cache.cmo jsutils.cmo config.cmo rdf.cmo sparql.cmo sparql_endpoint.cmo lisql.cmo permalink.cmo lisql_annot.cmo lexicon.cmo grammar.cmo lisql2nl.cmo ontology.cmo lisql2sparql.cmo lisql_type.cmo lis.cmo html.cmo
