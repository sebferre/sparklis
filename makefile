...
OBJ=common.cmo jsutils.cmo rdf.cmo sparql_endpoint.cmo lisql.cmo permalink.cmo sparql.cmo lexicon.cmo config.cmo lisql2nl.cmo lisql2sparql.cmo lis.cmo html.cmo
